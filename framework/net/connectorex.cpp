...
CConnectorEx::CConnectorEx(uint32 uId,
  ...
  pConnector->SetCallbackFunc(&ConnectorFuncOnDisconnected, &ConnectorFuncOnConnectFailed, &ConnectorFuncOnConnectted,
							  &ConnectorFuncOnSomeDataSend, &ConnectorFuncOnSomeDataRecv);
...
void CConnectorEx::SetCallbackFunc(FuncConnectorExOnDisconnected pOnDisconnected,
...
void CConnectorEx::ConnectorFuncOnDisconnected(CConnectorEx *pConnector) {
  pConnector->m_pFuncOnDisconnected(pConnector);
}

void CConnectorEx::ConnectorFuncOnConnectFailed(CConnectorEx *pConnector) {
  pConnector->m_pOnConnectFailed(pConnector);
}

void CConnectorEx::ConnectorFuncOnConnectted(CConnectorEx *pConnector) {
  pConnector->m_pOnConnectted(pConnector);
}

void CConnectorEx::ConnectorFuncOnSomeDataSend(CConnectorEx *pConnector) {
  pConnector->m_pOnSomeDataSend(pConnector);
}

void CConnectorEx::ConnectorFuncOnSomeDataRecv(CConnectorEx *pConnector) {
  pConnector->m_pOnSomeDataRecv(pConnector);
}