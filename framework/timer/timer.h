...
public:
	...
	// timer拥有者的实体ID
	OBJ_ID  GetOwnerEntityID() {return m_ulOwnerEntityID;}
	...
	void SetTimer(int iTimerMark, ERunTimeMode enRunTimeMode, time_t tMillTime, CallFunc func, int iCalledNum, int iOwnerEntityID, OBJ_ID lOwnerID);
	...
	// timer拥有者的ID
	OBJ_ID GetOwnerID() {return m_ulOwnerID;}
...
public:
	...
	void SetSession(time_t tMillTime, CallFunc func, OBJ_ID iOwnerEntityID, OBJ_ID ulOwnerID = 0, bool bContinues = false);
