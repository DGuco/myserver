...
class CSocketInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CSocketInfo) */ {
 public:
  ...
  inline CSocketInfo* New() const final {
    return CreateMaybeMessage<CSocketInfo>(NULL);
  }

  CSocketInfo* New(::google::protobuf::Arena* arena) const final {
...
class CMesHead : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMesHead) */ {
 public:
  ...
  inline CMesHead* New() const final {
    return CreateMaybeMessage<CMesHead>(NULL);
  }

  CMesHead* New(::google::protobuf::Arena* arena) const final {
  ...
  private:
  const ::CSocketInfo& _internal_socketinfos() const;
  public:
...
class CMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMessage) */ {
 public:
  ...
  inline CMessage* New() const final {
    return CreateMaybeMessage<CMessage>(NULL);
  }

  CMessage* New(::google::protobuf::Arena* arena) const final {
...
class CProxyHead : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CProxyHead) */ {
 public:
  ...
  inline CProxyHead* New() const final {
    return CreateMaybeMessage<CProxyHead>(NULL);
  }

  CProxyHead* New(::google::protobuf::Arena* arena) const final {
...
class CProxyMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CProxyMessage) */ {
 public:
  ...
  inline CProxyMessage* New() const final {
    return CreateMaybeMessage<CProxyMessage>(NULL);
  }

  CProxyMessage* New(::google::protobuf::Arena* arena) const final {
...
// optional .CSocketInfo socketInfos = 2;
inline bool CMesHead::has_socketinfos() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CMesHead::set_has_socketinfos() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CMesHead::clear_has_socketinfos() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CMesHead::clear_socketinfos() {
  if (socketinfos_ != NULL) socketinfos_->Clear();
  clear_has_socketinfos();
}
inline const ::CSocketInfo& CMesHead::_internal_socketinfos() const {
  return *socketinfos_;
}
inline const ::CSocketInfo& CMesHead::socketinfos() const {
  const ::CSocketInfo* p = socketinfos_;
  // @@protoc_insertion_point(field_get:CMesHead.socketInfos)
  return p != NULL ? *p : *reinterpret_cast<const ::CSocketInfo*>(
      &::_CSocketInfo_default_instance_);
}
inline ::CSocketInfo* CMesHead::release_socketinfos() {
  // @@protoc_insertion_point(field_release:CMesHead.socketInfos)
  clear_has_socketinfos();
  ::CSocketInfo* temp = socketinfos_;
  socketinfos_ = NULL;
  return temp;
}
inline ::CSocketInfo* CMesHead::mutable_socketinfos() {
  set_has_socketinfos();
  if (socketinfos_ == NULL) {
    auto* p = CreateMaybeMessage<::CSocketInfo>(GetArenaNoVirtual());
    socketinfos_ = p;
  }
  // @@protoc_insertion_point(field_mutable:CMesHead.socketInfos)
  return socketinfos_;
}
inline void CMesHead::set_allocated_socketinfos(::CSocketInfo* socketinfos) {
  ...
  if (socketinfos) {
    ...
    if (message_arena != submessage_arena) {
      socketinfos = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, socketinfos, submessage_arena);
    }
    set_has_socketinfos();
  } else {
    clear_has_socketinfos();
  ...
  // @@protoc_insertion_point(field_set_allocated:CMesHead.socketInfos)
}
