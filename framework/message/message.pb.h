...
class CMesHead : public ::google::protobuf::Message {
 public:
  CMesHead();
  virtual ~CMesHead();
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMesHead* default_instance_;
};
// -------------------------------------------------------------------
...
class CMessage : public ::google::protobuf::Message {
 public:
  ...
  inline const ::CMesHead& msghead() const;
  inline ::CMesHead* mutable_msghead();
  inline ::CMesHead* release_msghead();
  inline void set_allocated_msghead(::CMesHead* msghead);
...
inline ::CMesHead* CMessage::mutable_msghead() {
  set_has_msghead();
  if (msghead_ == NULL) msghead_ = new ::CMesHead;
  return msghead_;
}
