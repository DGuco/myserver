...
#ifndef PROTOBUF_INCLUDED_dbmessage_2eproto
#define PROTOBUF_INCLUDED_dbmessage_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_dbmessage_2eproto 
...
class CMsgExecuteSqlRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMsgExecuteSqlRequest) */ {
 public:
  ...
  inline CMsgExecuteSqlRequest* New() const final {
    return CreateMaybeMessage<CMsgExecuteSqlRequest>(NULL);
  }

  CMsgExecuteSqlRequest* New(::google::protobuf::Arena* arena) const final {
...
class CMsgExecuteSqlResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMsgExecuteSqlResponse) */ {
 public:
  ...
  inline CMsgExecuteSqlResponse* New() const final {
    return CreateMaybeMessage<CMsgExecuteSqlResponse>(NULL);
  }

  CMsgExecuteSqlResponse* New(::google::protobuf::Arena* arena) const final {
...
inline ::std::string* CMsgExecuteSqlRequest::release_sqlwhere() {
  ...
  clear_has_sqlwhere();
  return sqlwhere_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_dbmessage_2eproto
