...
//		}
	...
	void SetNext(CDoubleLinker* pPtr) {mpNext = pPtr;}
	CDoubleLinker* GetNext() {return mpNext;}

	void SetPrev(CDoubleLinker* pPtr) {mpPrev = pPtr;}
	CDoubleLinker* GetPrev() {return mpPrev;}

	// 是否在链表中
	bool InLinker() {return (mpPrev == NULL && mpNext == NULL) ? false : true; }
...
//		}
	...
	void SetHead(CDoubleLinker* pPtr) {mpHead = pPtr;}
	CDoubleLinker* GetHead() {return mpHead;}
	void ClearHead() {mpHead = NULL;}

	void SetEnd(CDoubleLinker* pPtr) {mpEnd = pPtr;}
	CDoubleLinker* GetEnd() {return mpEnd;}
	void ClearEnd() {mpEnd = NULL;}

	int GetCnt() {return miCnt;}
