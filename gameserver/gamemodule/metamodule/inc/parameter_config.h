...
public:
	...
	{ return _integer; }
	const float GetFloater() const
	{ return _floater; }
	const double GetDouble() const
	{ return _doubler; }
	const std::string &GetStr() const
	{ return _str; }
	const std::map<std::string, std::vector<int> *> &GetStrMap() const
	{ return _common; }
	const std::vector<int> &GetVector() const
	{ return _vi; }
	const std::map<int, int> &GetiiMap() const
	{ return _iimap; }
	const std::map<int, float> &GetifMap() const
	{ return _ifmap; }
...
public:
	...
	const std::map<std::string, ParameterItem *> &GetDatas() const
	{ return _datas; }
private:
	std::map<std::string, ParameterItem *> _datas;
};

template<class ParameterConfig> shared_ptr<ParameterConfig> CSingleton<ParameterConfig>::spSingleton = NULL;
