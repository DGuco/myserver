...
const CNetWork *CGameServer::GetNetWork()
{
	return m_pNetWork;
}
...
bool CGameServer::Connect2Proxy()
{
	...
	if (!m_pNetWork->Connect(rTmpProxy->m_sHost.c_str(),
							 rTmpProxy->m_iPort,
							 &CGameServer::lcb_OnCnsDisconnected,
							 &CGameServer::lcb_OnConnectFailed,
							 &CGameServer::lcb_OnConnectted,
							 &CGameServer::lcb_OnCnsSomeDataSend,
							 &CGameServer::lcb_OnCnsSomeDataRecv,
							 &CGameServer::lcb_OnPingServer,
...
void CGameServer::lcb_OnConnectted(CConnector *pConnector)
{

}

void CGameServer::lcb_OnOnConnectFailed(CConnector *pConnector)
{

}

void CGameServer::lcb_OnCnsDisconnected(CConnector *pConnector)
{

}

void CGameServer::lcb_OnCnsSomeDataRecv(CConnector *pConnector)
{

}

void CGameServer::lcb_OnCnsSomeDataSend(CConnector *pConnector)
{

}
void CGameServer::lcb_OnConnectFailed(CConnector *pConnector)
{

}

void CGameServer::lcb_OnPingServer(CConnector *pConnector)
{
