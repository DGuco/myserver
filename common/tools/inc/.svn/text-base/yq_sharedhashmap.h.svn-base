/******************************************************************************
	...
	1 日期			: 2009-06-26
		...
		修改内容	: 生成
*******************************************************************************/
#ifndef __YQ_SHAREHASHMAP_H__
#define __YQ_SHAREHASHMAP_H__
...
namespace yq
{
	...
	template < class _Kty, class _Ty, std::size_t _Cap, std::size_t _BCap  >
	yq::fixed_size_memory_pool< std::pair<_Kty, _Ty>, _Cap, 2>* shared_hash_map<_Kty, _Ty,_Cap, _BCap>::hash_table_ = NULL;

};

#endif // __YQ_SHAREHASHMAP_H__
