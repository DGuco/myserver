...
//static const char* pacRunTimeModeName[] =
//{
//			"ERTM_GAME",
//			"ERTM_PHYSICAL"
//};
...
{
	mTimerQueue.initialize();
	mTimerFinder.initialize();
	mSessionQueue.initialize();
	mDeleteList.initialize();
...
//int CTimerManager::Resume()
//{
//	return 0;
//}


//void* CTimerManager::operator new(size_t nSize)
//{
//	return (void*) mShmPtr->CreateSegment(nSize);
//}


//void  CTimerManager::operator delete(void* pMem)
//{
//
//}


//size_t CTimerManager::CountSize()
//{
//	return sizeof(CTimerManager);
//}
